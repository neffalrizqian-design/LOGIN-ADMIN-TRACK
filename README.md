...
<body>
    ...
    <video id="videoBgLogin" autoplay loop muted playsinline>
        <source src="baground_utama.mp4" type="video/mp4">
    </video>
    ...
    <script>
        ...
        const firebaseConfig = {
            apiKey: "AIzaSyB_DIxtakjRqS9qbtD9_SLU-i_FTf5zp3Q",
            authDomain: "cara-hack-nasa.firebaseapp.com",
            projectId: "cara-hack-nasa",
            storageBucket: "cara-hack-nasa.firebasestorage.app",
            messagingSenderId: "766570092118",
            appId: "1:766570092118:web:b2cb4e10f3f9c847978df7",
            measurementId: "G-1ZPKJZF9TE"
        };
        ...
        // ========================================
        // 🔥 TAMBAHAN: FUNGSI PLAY INTRO VIDEO DARI JAVA
        // ========================================
        function playIntroVideo() {
            if (window.Android) {
                ...
                console.log('⚠️ Java bridge tidak tersedia, menggunakan fallback HTML');
                // Fallback HTML
                if (videoIntroContainer && videoIntro) {
                    ...
                    videoIntro.play().catch(function(e) {
                        console.log('Intro video fallback error:', e);
                    });
                }
            }
        }
        ...
        // ========================================
        // FUNGSI PLAY INTRO (HTML FALLBACK)
        // ========================================
        function playIntro() {
            isIntroPlaying = true;
            videoIntroContainer.classList.add('show');
            ...
            videoIntro.play().then(function() {
                console.log('🎬 Intro video playing with sound (HTML fallback)');
            }).catch(function(err) {
        ...
        loginBtn.addEventListener('click', function() {
            ...
            if (username === USERNAME && password === PASSWORD) {
                ...
                setTimeout(function() {
                    ...
                    // Tampilkan dashboard setelah intro selesai
        ...
        window.addEventListener('load', function() {
            ...
            console.log('🎬 Video Background: baground_utama.mp4 (NO SOUND)');
            console.log('🎬 Video Intro: intro.mp4 (WITH SOUND)');
